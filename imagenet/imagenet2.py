...
parser.add_argument('-stop','--stop-batch',default=None, type=int,
                    metavar='SN',
                    help='Number of pictures during training for each epoch where training is supposed to stop'
                    )
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (images, target) in enumerate(train_loader):
        if (args.stop_batch == None) or (args.stop_batch>(counter*args.batch_size)):
